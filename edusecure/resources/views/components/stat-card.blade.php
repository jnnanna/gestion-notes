...
<div class="p-6 rounded-xl bg-white dark:bg-[#1a2234] border border-[#e7ebf3] dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
    <div class="flex items-center justify-between mb-4">
        ...
        @if($icon)
            <span class="p-2 rounded-lg {{ $iconBgClasses[$iconBg] ?? $iconBgClasses['blue'] }}">
    ...
    <div class="space-y-2">
        ...
        @if($trend && $trendValue)
            <div class="flex items-center gap-1 {{ $trendClasses[$trend] ?? $trendClasses['neutral'] }} text-xs font-medium">
