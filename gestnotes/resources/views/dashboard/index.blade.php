...
<div class="flex h-screen w-full">
    ...
    <main class="flex flex-col flex-1 h-full overflow-hidden relative">
        ...
        <!-- Scrollable Body -->
        <!-- We expose two containers: #dashboard-variant1 and #dashboard-variant2. JS in header toggles them. -->
        <div class="flex-1 overflow-y-auto">
            <div id="dashboard-variant1" class="p-4 md:p-8 space-y-8">
                <!-- Welcome Section -->
                <div>
            ...
            <div id="dashboard-variant2" class="hidden p-4 md:p-8 space-y-6">
                @include('dashboard.partials.variant2-content')
            </div>
        </div>
    </main>
</div>
